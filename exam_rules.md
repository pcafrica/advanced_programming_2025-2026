...
:warning: **Note**: Please make sure to have access to the course page on the [**Google Classroom**](https://classroom.google.com/c/ODA4NDQ4MzcwMTQw?cjc=xjhuxupx) platform.
...
Allowed programming languages include C++, Python, GNU Makefile, CMake, and shell scripting.
...
## Format
The exam submissions will be conducted through the Google Classroom platform. Please make sure to provide valid personal information and email address.
