...
Lectures at SISSA. Check out [GitHub](https://github.com/pcafrica/advanced_programming_2025-2026) regularly for up-to-date timetable, lecture topics, rooms, and course material.
...
1. (Optional) **Homework assignments** (up to 5 points):
   - Throughout the course, you will be assigned homework projects to complete either individually or in groups. Detailed instructions will be uploaded.
...
# Impact of advanced programming today
- **Data mastery** → Big datasets, smart algorithms.
- **Integration & customization** → Connect tools, tailor solutions.
- **Speed & performance** → Optimize code, push limits.
- **AI & ML** → Python leads, C++ boosts.
- **Visuals & prototyping** → Clear insights, fast iterations.
- **Automation & scalability** → Workflows on autopilot, built to grow.
- **Security & reliability** → Safe, shareable, reproducible code.

---

# Why should I learn programming in the AI era? (1/2)

1. **Buggy code**
   Developers using AI assistants often produce *less secure* code.
   [Stanford Study (2023)](https://arxiv.org/abs/2211.03622)

2. **Outdated knowledge**
   AI models don't know the latest library/API changes by default.
   (GPT-5 core training cutoff is 2024)

3. **Hallucinated code**
   LLMs invent non-existent methods or libraries.
   [CodeMirage dataset](https://arxiv.org/abs/2408.08333)

4. **Security vulnerabilities**
   ~40% of Copilot's code contains security flaws.
   [NYU Tandon Study](https://cyber.nyu.edu/2021/10/15/ccs-researchers-find-github-copilot-generates-vulnerable-code-40-of-the-time/)

---

# Why should I learn programming in the AI era? (2/2)

5. **Copyright & licensing risks**
   AI may reproduce GPL or proprietary code → legal conflicts.
   [Bloomberg Law Guidance](https://www.bloomberglaw.com/external/document/X4H9CFB4000000/copyrights-professional-perspective-ip-issues-with-ai-code-gener)

6. **Debugging becomes harder**
   AI-generated _black box_ code is tough to maintain.
   [Copilot User Study (2023)](https://arxiv.org/abs/2302.06590)

7. **Shallow learning**
   Students relying on AI acquire fewer problem-solving skills.
   [CS Education Study (2023)](https://doi.org/10.1186/s41239-023-00411-8)

8. **Inconsistent standards**
   AI doesn't follow your project's architecture or style.
   [Coding Style Inconsistencies in LLMs](https://arxiv.org/abs/2407.00456)
...
```
git clone git@github.com:pcafrica/advanced_programming_2025-2026.git
```
<br><br>
